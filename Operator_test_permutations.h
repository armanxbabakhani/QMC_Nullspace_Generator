...
#define Nop      8  // This defines the number of operators in the Hamiltonian
...
std::bitset<N> P_matrix[Nop] = {std::bitset<N>("000011"), std::bitset<N>("000101"), std::bitset<N>("001010"), std::bitset<N>("001100"), std::bitset<N>("010100"), std::bitset<N>("011000"), std::bitset<N>("101000"), std::bitset<N>("110000")};
...
std::bitset<Nop> Meas_Op[Ncycles] = {std::bitset<Nop>("00100000"), std::bitset<Nop>("00010000")};
